...
**Test Suite:** 2853 backend tests passing + 325 frontend tests passing = **3178 total**, 0 failures ✅
...
- DM Function Calling (Phase 3.5b — AoE multi-target spell resolution; UI polish: dice tumble animation, HP-bar shake, collapsed-by-default old events)
